# Generated by Django 2.2.14 on 2021-03-26 17:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_type', models.CharField(choices=[('S', 'Biling'), ('B', 'Shipping')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('GD', 'Graphic Design'), ('MG', 'Motion Graphic'), ('LD', 'Logo Design'), ('BC', 'Buisness Card'), ('IN', 'Intor Design')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger'), ('I', 'info')], max_length=1)),
